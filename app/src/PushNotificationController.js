...
export default class PushNotificationController {
    ...
    localNotification(notificationId, notificationTitle, notificationBody) {
        console.log("localNotification sent! ", notificationId);
        this.lastId++;
        PushNotification.localNotification({
            /* Android Only Properties */
            id: '' + notificationId, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
            ticker: notificationTitle + ' - ' + notificationBody, // (optional)
            autoCancel: true, // (optional) default: true
            largeIcon: "ic_launcher", // (optional) default: "ic_launcher"
            smallIcon: "ic_notification", // (optional) default: "ic_notification" with fallback for "ic_launcher"
            // bigText: "My big text that will be shown when notification is expanded", // (optional) default: "message" prop
            // subText: "This is a subText", // (optional) default: none
            color: "#fffd00", // (optional) default: system default
    ...
    onNotification(notification) {
        ...
        this.localNotification(notification.id, notification.title, notification.body);
    }
}