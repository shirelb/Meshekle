...
describe("PhoneBookScreen should", () => {
    ...
    test('match snapshot', async () => {
        const arrResponse = setupComponent('shallow', PhoneBookScreen, null, props, "/phoneBook");
    ...
    test("render with what the user see", async () => {
        const arrResponse = await setupComponent('mount', PhoneBookScreen, history, props, "/phoneBook");
        wrapper = arrResponse[0];
        componentInstance = arrResponse[1];

        const mountWrapper = wrapper.find('PhoneBookScreen');
    ...
    test("open UserInfo on click User /phoneBook/user/549963652", async () => {
        ...
        const userInfoLink = wrapper.find('PhoneBookScreen').find('Link').at(0);
    ...
    test("open ServiceProviderInfo on click ServiceProvider /phoneBook/serviceProvider/804790549  ", async () => {
        ...
        const serviceProviderInfoLink = wrapper.find('PhoneBookScreen').find('Link').at(41);
    ...
    test("save as PDF on click", async () => {
        ...
        const PDFBtn = wrapper.find('PhoneBookScreen').find('Button').at(0);
        ...
        const PDFBtn2 = wrapper.find('PhoneBookScreen').find('Button').at(2);
    ...
    test("save as Excel on click", async () => {
        ...
        const excelBtn = wrapper.find('PhoneBookScreen').find('CSVLink').at(0);
        await excelBtn.simulate('click', {button: 0});

        expect(componentInstance.state.usersCSV).toHaveLength(1000);

        const excelBtn2 = wrapper.find('PhoneBookScreen').find('CSVLink').at(1);
    ...
    test("render page of users on click of another page", async () => {
        ...
        const page3Btn = wrapper.find('PhoneBookScreen').find('MenuItem').at(2);
    ...
    test("render page of serviceProviders on click of another page", async () => {
        ...
        const page3Btn = wrapper.find('PhoneBookScreen').find('MenuItem').at(30);
        await page3Btn.simulate('click', {button: 0});
    ...
    test("render next page of users on click", async () => {
        ...
        const nextPageBtn = wrapper.find('PhoneBookScreen').find('MenuItem').at(25);
    ...
    test("render next page of serviceProviders on click", async () => {
        ...
        const nextPageBtn = wrapper.find('PhoneBookScreen').find('MenuItem').at(36);
        await nextPageBtn.simulate('click', {button: 0});
    ...
    test("render previous page of users on click", async () => {
        ...
        const page10Btn = wrapper.find('PhoneBookScreen').find('MenuItem').at(10);
        await page10Btn.simulate('click', {button: 0});

        expect(componentInstance.state.pageUsers).toEqual(10);

        const previousPageBtn = wrapper.find('PhoneBookScreen').find('MenuItem').at(0);
    ...
    test("render previous page of serviceProviders on click", async () => {
        ...
        const page10Btn = wrapper.find('PhoneBookScreen').find('MenuItem').at(32);
        await page10Btn.simulate('click', {button: 0});

        expect(componentInstance.state.pageServiceProviders).toEqual(6);

        const previousPageBtn = wrapper.find('PhoneBookScreen').find('MenuItem').at(26);
        await previousPageBtn.simulate('click', {button: 0});
    ...
    test("filter user table by userId and active", async () => {
        const arrResponse = await setupComponent('mount', PhoneBookScreen, null, props, "/phoneBook");
        wrapper = arrResponse[0];
        componentInstance = arrResponse[1];
        ...
        await wrapper.find('PhoneBookScreen').find('Checkbox').at(0).simulate('change');
    ...
    test("filter serviceProvider table by serviceProviderId and active", async () => {
        ...
        await wrapper.find('PhoneBookScreen').find('Checkbox').at(1).simulate('change');
